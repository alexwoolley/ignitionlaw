...
<div class="row">
	<!-- <div class="col-md-8 col-md-offset-2 col-sm-6 col-sm-offset-3"> -->
			<div class="col-md-4 col-md-offset-2 col-sm-6 col-sm-offset-3 text-justify gunnercooke-curves">
				<h3 class="gunnercooke-heading">On brief</h3>
			...
			<div class="col-md-4 col-md-offset-0 col-sm-6 col-sm-offset-3 text-justify gunnercooke-curves">
				<h3 class="gunnercooke-heading">On budget</h3>
...
<div class="row">
			<div class="col-md-4 col-md-offset-2 col-sm-6 col-sm-offset-3 text-justify gunnercooke-curves">
				<h3 class="gunnercooke-heading">On time</h3>
			...
			<div class="col-md-4 col-md-offset-0 col-sm-6 col-sm-offset-3 text-justify gunnercooke-curves">
				<h3 class="gunnercooke-heading">In a network</h3>
